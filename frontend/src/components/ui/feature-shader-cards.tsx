...
function FeatureCard({ feature, reduceMotion }: { feature: FeatureCardData; reduceMotion: boolean }) {
  ...
  return (
    <div className="relative group w-full h-full min-h-[290px] flex flex-col rounded-2xl overflow-hidden border border-white/10 bg-gradient-to-b from-zinc-900/80 via-zinc-950/90 to-black backdrop-blur-xl hover:border-white/30 transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_10px_30px_rgba(255,255,255,0.07)]">
      ...
      <div className="relative z-10 p-6 lg:p-7 flex flex-col justify-between flex-1 h-full">
        ...
        <div className="flex flex-col text-left">
          ...
          {/* Feature Description */}
          <p className="text-sm lg:text-base text-zinc-300 font-normal leading-relaxed mb-6">
            {feature.description}
          </p>
        </div>
